...
public class TouchView extends View {
    ...
    private void init(Context context) {
        ...
        setLineParameters(Color.BLACK,2);
...
//        Log.d(TAG,"getmLeftBottomPosX: "+ getmLeftBottomPosX());
//        Log.d(TAG,"getmLeftBottomPosY: "+ getmLeftBottomPosY());
//
//        Log.d(TAG,"getmLeftTopPosX: "+ getmLeftTopPosX());
//        Log.d(TAG,"getmLeftTopPosY: "+ getmLeftTopPosY());
//
//        Log.d(TAG,"getmRightBottomPosY: "+ getmRightBottomPosY());
//        Log.d(TAG,"getmRightBottomPosY: "+ getmRightBottomPosY());
//
//        Log.d(TAG,"getmRightTopPosX: "+ getmRightTopPosX());
//        Log.d(TAG,"getmRightTopPosY: "+ getmRightTopPosY());
        return intercept;
    }
